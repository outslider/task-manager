...
| チケットの集計 | 日次・週次で「受けた数」と「片付いた数」を並べ、溜まっているかどうかを見ます。窓口別・種別別の内訳と平均対応日数つき。CSV に落とせます |
...
|---|---|
| 番号 | 全社通し番号。`#123` で呼べます |
| 種別 | 📋 依頼／💬 問い合わせ／🚨 障害。障害を選ぶと**発生日時**の欄が出ます |
...
│   ├── test_tickets.py    チケットの受付・集計・取り込み（83 ケース）
