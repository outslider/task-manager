...
const PATHS = {
  scale: ['<path d="M12 3.5v17M7 20.5h10M5 7h14"/>',
    '<path d="M5 7l-2.6 6.2a2.8 2.8 0 005.2 0zM19 7l-2.6 6.2a2.8 2.8 0 005.2 0z"/>'],
  ...
  sparkle: ['<path d="M12 3.6c.5 3.6 1.9 5.9 5.9 6.6-4 .7-5.4 3-5.9 6.6-.5-3.6-1.9-5.9-5.9-6.6'
    + ' 4-.7 5.4-3 5.9-6.6z"/>', '<path d="M18.4 15.2c.2 1.3.7 2 2 2.3-1.3.3-1.8 1-2 2.3-.2-1.3-.7-2-2-2.3'
    + ' 1.3-.3 1.8-1 2-2.3z"/>'],
